...
WebUI.setText(findTestObject('Page_practice-form/input_Email'), 'usertesting@testing.com')

WebUI.click(findTestObject('Page_practice-form/input_Male'))

WebUI.setText(findTestObject('Page_practice-form/input_Mobile Number'), '123456789')
